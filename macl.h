...
#define SUBGHZ_HOPPING_RESYNC_INTERVAL			( 24*3600ul*1000ul )
#define SUBGHZ_HOPPING_TX_SCAN_REQUEST_INTERVAL	( 100u ) // ms
#define SUBGHZ_HOPPING_SCAN_INTERVAL			( 5*1000u ) // ms
